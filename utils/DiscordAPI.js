...
export const OAUTH = {
    discord: (clientId, scope) => { return `https://discordapp.com/oauth2/authorize?client_id=${clientId||'900242114800152576'}&scope=${scope||'0'}&response_type=code&redirect_uri=${process.env.BASE_URL|| 'http://localhost:3000'}/discord/callback` }
}